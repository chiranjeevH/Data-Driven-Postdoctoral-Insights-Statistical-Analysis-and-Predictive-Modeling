...
# def diagnostic_plots(initial_model, X_with_const, y_standardized, model_name, outcome_var):
#     """
...
with pd.ExcelWriter('Full_Dataset_Model_Analysis_Result.xlsx') as writer:
